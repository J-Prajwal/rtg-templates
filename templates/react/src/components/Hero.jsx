export const HeroLight = ({ libraries = [{{RTG_LIBRARIES}}] }) => {
  return (
    <>
      <style>{`
        .hero-light-grid {
      ...
      <section className="hero-light-section hero-light-gradient-bg">
        ...
        <div className="hero-light-container">
          ...
          <p className="hero-light-subtitle">Production-level React & JavaScript boilerplates that save hours of setup time</p>
